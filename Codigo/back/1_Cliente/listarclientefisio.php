...
?>	
    <tbody>
      <tr>
        <th scope="row">
        <input type="radio" name="selecao" value="<?php echo $cpfs[$i];?>" id="selecao" onClick="preencheBotoesConsultaClienteFisio(this.value);" />
        </th>
...
?>	
    ...
    <a class="btn btn-secondary btn-lg" href="../1_Cliente/ConsultarClienteFisio.html" role="button">Cancelar</a>
