...
<div class="jumbotron">
  ...
  <p class="h1">Listar Clientes Inadimplentes</p>
  ...
  <table class="table">
    <thead class="thead-dark">
      <tr>
        ...
        <th scope="col">Data do Pagamento N&atilde;o Realizado</th>        
...
if($quantos > 0)	
{
    ...
    else
    {
      $diaspagamento = 365 ;
          ...
          FROM pagamento a where a.cpfCliente = '".$cpfs[$i]."' and situacaoPagamento = 2 ";
