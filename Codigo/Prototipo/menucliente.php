            ...
            {             
                        ...
                        try
                        {
                            $sql_insert = "insert into presenca 
                                            (nomeAula, cpfCliente , nomeInstrutor_0, dataAula, id_aula) 
                                            values
                        (
                            ...
                            ,STR_TO_DATE('".$_POST["dataaula"]."', '%d/%m/%Y') 
                            ,".$_POST["idaula"]."
                        )";
...
if($_REQUEST["selecao"] == "")
{
       ...
       exit;	
            ...
            else
            {
                ...
                $sql_nome_aula = "SELECT nomeAula, nomeInstrutor_0 , horarioInicio, horarioFim from aula where id_aula =".$_REQUEST["selecao"];
        ...
        ?>
            ...
            <div class="form-group">
                <label for="inputInicio">Data da Aula</label>
            <input type="text" class="form-control" id="dataaula" name="dataaula" maxlength="10" <?php if($horainicio!= ""){ ?> value="<?php $dataori = explode("-",$horainicio); echo $dataori[2]."/".$dataori[1]."/".$dataori[0];?>" <?php } ?> onkeypress="mascaraData( this, event )" placeholder="01/01/1900">
            </div>
            <div class="form-group">
...
else if($_REQUEST["acao"] == "listarpresencas")
{
        ...
        ?>		
            ...
            <tr>
                ...
                <td><?php $dataori = explode("-",$periodosi[$i]); echo $dataori[2]."/".$dataori[1]."/".$dataori[0];?></td>		
            </tr>
            </tbody>
        <?php
            }
